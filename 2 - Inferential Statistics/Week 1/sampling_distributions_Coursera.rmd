...
```{r sampling-dist}
# type your code for the Exercise here, and Run Document
# 1.  There are 2 elements: replicate and x_bar
# 2.  Sampling distribution is normal and symmetric
# 3.  Center is at x_bar ~ 1500
...
# 1. Uniform and symmetric
# 2. mean ~ 185,000
# 3. Less variance than in sample_means50
```
...
# 1. Uniform and symmetric
# 2. Mean home price ~ $185,000
# 3. Population mean = $183434.2
```
